...
export const elements = {
  mainUserWelcome: document.getElementById("mainUserWelcome"),
  mainLogoutBtn: document.getElementById("mainLogoutBtn"),
  ...
  newCaseRespondent: document.getElementById("newCaseRespondent"),
  newCaseReason: document.getElementById("newCaseReason"),
...
export function syncAddEvidenceButton() {
  if (!elements.addEvidenceOpenBtn) return;
  elements.addEvidenceOpenBtn.disabled = !elements.caseSelect?.value;
}