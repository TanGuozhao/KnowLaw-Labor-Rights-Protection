    ...
    function appendTextToNode(node) {
        return node.append('text')
                   ...
                   .attr('fill', function(d) {
                       return icon(d) ? '#ffffff' : '#0f172a';
                   })
                   .attr('font-size', function(d) {
                       return icon(d) ? (options.nodeRadius + 'px') : '11px';
                   })
                   ...
                   .each(function(d) {
                       ...
                       if (_icon) {
                           ...
                           var cap = (d.properties && (d.properties.label || d.properties.name)) ? String(d.properties.label || d.properties.name) : String(d.id);
                           if (cap.length > 14) {
                               cap = cap.slice(0, 13) + '\u2026';
                           }
                           el.text(cap);
